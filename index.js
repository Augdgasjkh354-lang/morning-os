...
app.use(require('./routes/settings')(deps)); app.use(require('./routes/memory')(deps)); app.use(require('./routes/tasks')(deps)); app.use(require('./routes/chat')(deps)); app.use(require('./routes/conversations')(deps)); app.use(require('./routes/report')(deps)); app.use(require('./routes/research')(deps));
