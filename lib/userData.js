...
const DEFAULTS = {
  'settings.json': { agent_enabled: true, portrait_auto_generate: true },
...
async function ensureDataDirs() { await ensureDir(USERS_DIR); }
...
module.exports = { DATA_ROOT, USERS_DIR, getUserDataPath, readUserData, writeUserData, getUserSettings, saveUserSettings, getUserMemory, saveUserMemory, getUserTasks, saveUserTasks, getUserResearch, saveUserResearch, getUserConversationPath, getUserReportsPath, ensureDir, ensureDataDirs };
