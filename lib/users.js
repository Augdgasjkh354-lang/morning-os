...
const { USERS_DIR, ensureDir, getUserDataPath } = require('./userData');
const USERS_PATH = path.join(DATA_ROOT, 'users.json');
const INVITES_PATH = path.join(DATA_ROOT, 'invites.json');
const APP_CONFIG_PATH = path.join(DATA_ROOT, 'app_config.json');
